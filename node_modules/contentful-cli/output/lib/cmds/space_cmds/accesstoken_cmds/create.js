...
module.exports.builder = yargs => {
    return yargs
        ...
        .option('environment', {
        alias: 'e',
        describe: 'Environment the access token will have access to. Defaults to "master" if omitted'
    })
...
async function accessTokenCreate(argv) {
    const { context, name, description, silent, environment, feature = 'space-access_token-create' } = argv;
