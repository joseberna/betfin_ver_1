...
var $defineProperty$2 = GetIntrinsic$3('%Object.defineProperty%', true);
var hasToStringTag = requireShams()();
var hasOwn$2 = hasown;
var $TypeError$3 = requireType();
var toStringTag$2 = hasToStringTag ? Symbol.toStringTag : null;
...
var esSetTostringtag = function setToStringTag(object, value) {
  ...
  if (typeof overrideIfSet !== 'undefined' && typeof overrideIfSet !== 'boolean' || typeof nonConfigurable !== 'undefined' && typeof nonConfigurable !== 'boolean') {
    throw new $TypeError$3('if provided, the `overrideIfSet` and `nonConfigurable` options must be booleans');
  }
  if (toStringTag$2 && (overrideIfSet || !hasOwn$2(object, toStringTag$2))) {
    if ($defineProperty$2) {
      $defineProperty$2(object, toStringTag$2, {
      ...
      object[toStringTag$2] = value; // eslint-disable-line no-param-reassign
    }
  }
};
...
var rateLimitThrottle = (axiosInstance, type = 'auto') => {
  ...
  let limit = isString$2(type) ? calculateLimit(type) : calculateLimit('auto', type);
...
function createClient(params) {
  ...
  const userAgentHeader = getUserAgentHeader(`contentful.js/${"11.8.7"}`, config.application, config.integration);
