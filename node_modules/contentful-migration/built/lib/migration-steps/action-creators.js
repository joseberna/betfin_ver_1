...
const content_type_taxonomy_validation_1 = require("../intent/content-type-taxonomy-validation");
const actionCreators = {
    contentType: {
        ...
        setTaxonomyValidations: (id, instanceId, callsite, taxonomyValidations) => new Intents.ContentTypeTaxonomyValidation({
            type: 'contentType/update',
            meta: {
                contentTypeInstanceId: `contentType/${id}/${instanceId}`,
                callsite: {
        ...
        addTaxonomyValidation: (id, instanceId, callsite, taxonomyId, linkType, options) => new content_type_taxonomy_validation_1.ContentTypeAddTaxonomyValidationIntent({
            ...
            payload: {
                contentTypeId: id,
                taxonomyValidation: Object.assign({ sys: {
                        type: 'Link',
                        linkType,
                        id: taxonomyId
                    } }, ((options === null || options === void 0 ? void 0 : options.required) !== undefined && { required: options.required }))
            }
        }),
        clearTaxonomyValidations: (id, instanceId, callsite) => new content_type_taxonomy_validation_1.ContentTypeClearTaxonomyValidationsIntent({
